...
const newHtml = `<!-- FIREBASE ADMIN LOGIN GATE -->
...
const updatedContent = content.replace(/<!-- ADMIN PASSWORD GATE -->.*?<\/script>/s, newHtml);
fs.writeFileSync('admin.html', updatedContent, 'utf-8');
console.log('Done!');
